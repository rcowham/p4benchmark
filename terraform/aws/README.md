...
|------|-------------|------|---------|:--------:|
| <a name="input_ami"></a> [ami](#input\_ami) | AMI ID to use for Helix Core commit server | `map(string)` | <pre>{<br>  "ap-northeast-1": "ami-01e2129786264c400",<br>  "ap-northeast-2": "ami-0b2fa7ea904b161a2",<br>  "ap-northeast-3": "ami-03f0db6da7bf1306b",<br>  "ap-south-1": "ami-0ae3983379cc494e8",<br>  "ap-southeast-1": "ami-05e206dcf928c9078",<br>  "ap-southeast-2": "ami-08f949b2fcb6b3d31",<br>  "ca-central-1": "ami-040bde0518bd7a6ba",<br>  "eu-central-1": "ami-09c91fa399c2a81a5",<br>  "eu-north-1": "ami-06a373eb52abbdb68",<br>  "eu-west-1": "ami-03fb8569c4ace9810",<br>  "eu-west-2": "ami-0d2077cad9d054467",<br>  "eu-west-3": "ami-03fd0715c41b21f32",<br>  "sa-east-1": "ami-090e455d221336b23",<br>  "us-east-1": "ami-0455b6b2905b565f0",<br>  "us-east-2": "ami-060651d43696ebc01",<br>  "us-west-1": "ami-05ed8d8d0c5c5e7b9",<br>  "us-west-2": "ami-0b95e65da22d3f62b"<br>}</pre> | no |
...
| <a name="input_createfile_configs"></a> [createfile\_configs](#input\_createfile\_configs) | createfile\_configs is an array of maps.  Each object will be passed to createfiles.py.  Use an empty array if you want to skip running createfiles.py from terraform | `list(map(string))` | <pre>[<br>  {<br>    "createfile_directory": "ws1",<br>    "createfile_levels": "25 25",<br>    "createfile_number": "10000",<br>    "createfile_size": "10000"<br>  }<br>]</pre> | no |
...
| <a name="input_existing_helix_core_public_ip"></a> [existing\_helix\_core\_public\_ip](#input\_existing\_helix\_core\_public\_ip) | Existing helix core public IP for terraform to connect via remote-exec for configuration | `string` | `""` | no |
